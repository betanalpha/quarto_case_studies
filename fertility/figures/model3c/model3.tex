...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    \draw[white] (-8.75 * \d, -6.76 * \d) rectangle (-1.75 * \d, -0.75 * \d);
    ...
    \draw[dark, line width=1.5, rounded corners=2] (-6.75 * \d, -5.25 * \d) rectangle (-2.25 * \d, -1.25 * \d);

    \foreach \B/\E in {O/L, O/M, O/N, M/L,
                       P/O, Q/N, R/M, S/L} {
