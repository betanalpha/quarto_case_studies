...
require comparisons to \emph{new} observations.
...
that either of these modes actually provide a non-negligible
contribution to posterior inferences. Moreover, the mode to which each
Markov chain converges is not deterministic. If you run this code
yourself then you might see each Markov chain find the other mode!

Multimodal posterior distributions are notoriously difficult to
quantify. That said, Markov chain Monte Carlo at least provides useful
...
perform posterior retrodictive checks separately for each set of Markov
chains.
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1,}
                                \ControlFlowTok{function}\NormalTok{(s) s[}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{),]),}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chains 1, 2, and 4\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 28 predictive values (0.0%) fell below the binning.
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1,}
                                \ControlFlowTok{function}\NormalTok{(s) }\FunctionTok{array}\NormalTok{(s[}\DecValTok{3}\NormalTok{,], }\AttributeTok{dim=}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1024}\NormalTok{))),}
                         \StringTok{\textquotesingle{}log\_reading\_time\_pred\textquotesingle{}}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{10}\NormalTok{, }\FloatTok{0.1}\NormalTok{,}
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chain 3\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 1427 predictive values (0.1%) fell below the binning.
\end{verbatim}
...
explored by the third Markov chain, the posterior predictive reading
time behavior exhibits only a single peak. This clashes with the
observed reading time behavior. On the other hand, the first, second,
and forth Markov chains appear to be exploring behaviors that are much
more consistent with the observed data. Formally quantifying the
relative consistency, however, is difficult.

All of that said, the retrodictive performance for the first, second,
and forth Markov chains still leaves something to be desired. If we zoom
in then we see that, while the posterior predictive behavior is able to
replicate the observed peaks, the posterior predictive tails are not
quite right. Similar to what we saw with the log-normal dependency
locality model, the posterior predictive lower tail is too heavy and the
posterior predictive upper tail is too light.
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chains 1, 2, 4\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Even if the mode explored by the third Markov chain is irrelevant, the
posterior retrodictive tension in the mode explored by the first and
third Markov chains suggests that we can improve the direct-access model
by adding a bit more asymmetry to the component models.
...
\FunctionTok{text}\NormalTok{(}\FloatTok{0.25}\NormalTok{, }\DecValTok{12}\NormalTok{, }\StringTok{\textquotesingle{}Subject}\SpecialCharTok{\textbackslash{}n}\StringTok{Relative\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid)}
...
\FunctionTok{text}\NormalTok{(}\FloatTok{0.35}\NormalTok{, }\DecValTok{15}\NormalTok{, }\StringTok{\textquotesingle{}Object}\SpecialCharTok{\textbackslash{}n}\StringTok{Relative\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_dark)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{mar =} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{))}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples\_dat2[[}\StringTok{\textquotesingle{}lambda\_SR\textquotesingle{}}\NormalTok{]], }\DecValTok{25}\NormalTok{,}
                                ...
                                \AttributeTok{display\_name=}\StringTok{"Initial Success Probability"}\NormalTok{,}
                                \AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid,}
                                \AttributeTok{main=}\StringTok{"Direct Access Theory Model"}\NormalTok{)}
\FunctionTok{text}\NormalTok{(}\FloatTok{0.25}\NormalTok{, }\DecValTok{12}\NormalTok{, }\StringTok{\textquotesingle{}Subject}\SpecialCharTok{\textbackslash{}n}\StringTok{Relative\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid)}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples\_joint[[}\StringTok{\textquotesingle{}lambda\_SR\textquotesingle{}}\NormalTok{]], }\DecValTok{25}\NormalTok{,}
                                ...
                                \AttributeTok{display\_name=}\StringTok{"Initial Success Probability"}\NormalTok{,}
                                \AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid,}
                                \AttributeTok{main=}\StringTok{"Joint Model"}\NormalTok{)}
\FunctionTok{text}\NormalTok{(}\FloatTok{0.25}\NormalTok{, }\DecValTok{12}\NormalTok{, }\StringTok{\textquotesingle{}Subject}\SpecialCharTok{\textbackslash{}n}\StringTok{Relative\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid)}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1r,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chains 1, 2, 4 (Censored)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 24 predictive values (0.0%) fell below the binning.
\end{verbatim}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1r,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chain 3 (Censored)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 1502 predictive values (0.1%) fell below the binning.
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{neg\_binomial\_2\_lpmf(y | exp(log\_mu), }\DecValTok{1}\NormalTok{ / phi)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{neg\_binomial\_2\_log\_lpmf(y | log\_mu, }\DecValTok{1}\NormalTok{ / phi)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chains 1, 2, 4 (Log Normal)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat1,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chain 3 (Log Normal)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat\_nb,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chains 1, 2, 4 (Negative Binomial)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 4014 predictive values (0.0%) fell below the binning.
\end{verbatim}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_hist\_quantiles}\NormalTok{(}\FunctionTok{lapply}\NormalTok{(samples\_dat\_nb,}
                         ...
                         \AttributeTok{baseline\_values=}\FunctionTok{log}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{reading\_time),}
                         \AttributeTok{xlab=}\StringTok{\textquotesingle{}Log Reading Time / 1 ms\textquotesingle{}}\NormalTok{,}
                         \AttributeTok{main=}\StringTok{\textquotesingle{}Markov Chain 3 (Negative Binomial)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Warning in check_bin_containment(bin_min, bin_max, collapsed_values,
"predictive value"): 27286 predictive values (1.0%) fell below the binning.
\end{verbatim}
...
helpful comments. Additionally, I thank jd for helpful feedback.
