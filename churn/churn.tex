...
is available on
\href{https://github.com/betanalpha/quarto_case_studies/tree/main/churn}{GitHub}.
\end{abstract}
...
\captionsetup{labelsep=none}\includegraphics{figures/events/churn/event.pdf}
...
\captionsetup{labelsep=none}\includegraphics{figures/events/active/event.pdf}
...
\KeywordTok{model}\NormalTok{ \{}
  ...
  \KeywordTok{target +=}\NormalTok{ normal\_lpdf(eta | }\DecValTok{0}\NormalTok{, }\DecValTok{40}\NormalTok{ / }\FloatTok{2.57}\NormalTok{);}
\NormalTok{\}}
...
\begin{verbatim}
179867 predictive values (1.76%) fell above the histogram binning.
\end{verbatim}

\includegraphics{churn_files/figure-pdf/cell-19-output-2.png}
...
\begin{verbatim}
55 predictive values (0.00%) fell above the histogram binning.
\end{verbatim}
...
\begin{verbatim}
3550 predictive values (0.04%) fell above the histogram binning.
\end{verbatim}
...
enough that our prior model is in \emph{okay} agreement with our roughly
...
models for \(\alpha\) and \(\sigma\), later if needed.
...
\begin{verbatim}
Last updated: 2026-06-13T15:39:24.963230-04:00
